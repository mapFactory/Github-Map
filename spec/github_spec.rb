...
describe "the interactions with the Github API" do
	...
	let(:check_invalid_result) { check({user: "miketestgit02", pass: "qzfreetf59i"}, 'master', {user: "miketestgit02", pass: "qzfreetf59im"}) }
	...
	it "should confirm repo has been created" do
		...
		expect( check_remote_exists({user: "miketestgit02", pass: "qzfreetf59im"}, "rspec_test_repo") ).to eq(true)
	end
